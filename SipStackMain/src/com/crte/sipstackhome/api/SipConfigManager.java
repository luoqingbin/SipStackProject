...
public class SipConfigManager {
     ...
     * 3-4: 使用小型过滤器采样<br/>
     * 1-2: 使用线性采样<br/>
     * 媒体质量也通过设置Speex编码器的质量/复杂性的数量<br/>
    ...
    /**
     * 如果几秒内的声音为空，将自动关闭音频设备，以毫秒为单位<br/>
     * 使用的值如果为-1，将禁用自动关闭音频设备的功能<br/>
     * <a target="_blank" href=
     ...
     * @see #setPreferenceStringValue(Context, String, String)
     */
    public static final Uri PREF_ID_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + AUTHORITY + "/" + PREFS_TABLE_NAME + "/");
    ...
    /**
     * Helper method to retrieve a csipsimple boolean config value <br/>
     * 辅助方法来检索一个CSipSimple配置
     *
     * @param ctxt         The context of your app
     * @param key          the key for the setting you want to get
     * @param defaultValue the value you want to return if nothing found

...
public final class SipManager {
     ...
     */
    public static final String INTENT_SIP_SERVICE = "com.crte.sipstackhome.service.SipService";
        
    /**
     * Shortcut to turn on / off a sip account. <br/>
     * 快捷方式打开或关键一个sip账户
     * <p>
     * Expected Extras :
     * <ul>
    ...
    /**
     * Broadcast sent when sip account has been changed. <br/>
     * 发送一个账户的改变广播
     * <p>
     * Provided extras :
     * <ul>
    ...
    /**
     * Broadcast sent when sip account registration has changed. <br/>
     * 发送一个账户的注册广播
     * <p>
     * Provided extras :
     * <ul>
     ...
     * 当SIP栈的状态发生改变时
     */
    public static final String ACTION_SIP_STACK_CHANGE = "com.crte.sipstackhome.SIP_STACK_CHANGE";
    /**
     * 发起视频或语音呼叫
     */
    public static final String ACTION_CALL_MAKE = "com.crte.sipstackhome.SIP_CALL_MAKE";
    /**
     * 关闭SIP协议栈
     */
    public static final String ACTION_FINISH = "com.crte.sipstackhome.SIP_FINISH";
    /**
    ...
    // Content provider
    public static final String AUTHORITY = "com.crte.sipstackhome.db.DatabaseContentProvider";
    /**

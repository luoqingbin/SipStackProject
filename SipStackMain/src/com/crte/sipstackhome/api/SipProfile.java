...
package com.crte.sipstackhome.api;
...
import com.crte.sipstackhome.api.SipUri.ParsedSipContactInfos;
import com.crte.sipstackhome.api.SipUri.ParsedSipUriInfos;
...
public class SipProfile implements Parcelable {
    ...
    /**
     * 自动传输选择<br/>
     * 默认使用UDP穿输，如果超过极限就切换到TCP<br/>
     * 注意：并不是每个SIP服务器都支持UDP/TCP
     */
    ...
    /**
     * @deprecated 使用Google Android 2.3的后台<br/>
     * 现在不支持
     */
     ...
     * 账户/SIP配置的URI
     */
    public final static Uri ACCOUNT_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + ACCOUNTS_TABLE_NAME);
    /**
     ...
     */
    public final static Uri ACCOUNT_ID_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + ACCOUNTS_TABLE_NAME + "/");
     ...
     * @see ContentUris#appendId(android.net.Uri.Builder, long)
     */
    public final static Uri ACCOUNT_STATUS_ID_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + ACCOUNTS_STATUS_TABLE_NAME + "/");
    /**
     * 短消息
     */
    public static final Uri CONTACT_SHORT_MESSAGE_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + DatabaseHelper.TABLE_SHORT_MESSAGE_NAME);
    /**
     * 联系人
     */
    public static final Uri CONTACT_PERSON_CONTENT_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + DatabaseHelper.TABLE_CONTACT_PERSON);
    /**
     * 通话记录
     */
    public static final Uri CONTACT_CALL_RECORD = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + DatabaseHelper.TABLE_CALL_RECORD);
    public static final Uri CONTACT_VIDEO_RECORD = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + DatabaseHelper.TABLE_VIDEO_RECORD);
    /**
     * 账户主键
     */
    ...
    /**
     * 用于向导内部使用的数据<br/>
     * 这里的格式是特定于该向导的，而且没有任何假设<br/>
     * 可SimpleString，JSON，Base64编码的东西等
     *
     * @see String
     */
    ...
    /**
     * 订阅消息的等待指示事件 (RFC 3842)
     * <a target="_blank" href="http://www.pjsip.org/pjsip/docs/html/structpjsua__acc__config.htm#a0158ae24d72872a31a0b33c33450a7ab">PJSIP 文档</a>
     */
    public static final String FIELD_MWI_ENABLED = "mwi_enabled";
    /**
     * 用于将账户保存到该账户所属的服务器上<br/>
     * <li>1 - true
     * <li>0 - false
     */
    ...
    /**
     * 注册可选的时间间隔<br/>
     * <a target="_blank" href="http://www.pjsip.org/pjsip/docs/html/structpjsua__acc__config.htm#a2c097b9ae855783bfbb00056055dd96c">PJSIP 文档</a>
     */
...
//        }
        ...
        args.put(FIELD_KA_INTERVAL, ka_interval); // 设置该账户周期性的活动传输的间隔时间，如果这个值为0，则禁用该账户。
    ...
    public static SipProfile getProfileFromDbId(Context ctxt, long accountId, String[] projection) {
        ...
        if (accountId != INVALID_ID) {
            // 查询指定用户信息
            Cursor c = ctxt.getContentResolver().query(ContentUris.withAppendedId(ACCOUNT_ID_URI_BASE, accountId), projection, null, null, null);
            if (c != null) {
                try {
                    if (c.getCount() > 0) {
                        c.moveToFirst();
                        account = new SipProfile(c); // 创建用户配置文件
                    }
                } catch (Exception e) {

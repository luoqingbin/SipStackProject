...
public class SipMessage {
     ...
     */
    public static final Uri MESSAGE_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + MESSAGES_TABLE_NAME);
    /**
     ...
     */
    public static final Uri MESSAGE_ID_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + MESSAGES_TABLE_NAME + "/");
    /**
     ...
     */
    public static final Uri THREAD_URI = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + THREAD_ALIAS);
    /**
     * Base uri for thread views.
     */
    public static final Uri THREAD_ID_URI_BASE = Uri.parse(ContentResolver.SCHEME_CONTENT + "://" + SipManager.AUTHORITY + "/" + THREAD_ALIAS + "/");

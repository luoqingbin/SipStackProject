...
public class pjsua implements pjsuaConstants {
  ...
  /**
   * 修改帐户配置设置。这个功能可能会触发注销（旧帐户设置）和重新登记（新帐户设置），
   * 例如：更改帐户ID证书，注册，或代理设置。
   * @param acc_id 
   * @param acc_cfg
   * @return
   */
  ...
  /**
   * 修改远程/在线用户的状态，这将发送NOTIFY请求。
   * @param acc_id 账户ID
   * @param is_online true 或 false
   * @return
   */
   ...
   * 更新注册或进行注销账户。
   * @param acc_id 账户ID
   * @param renew 如果更新参数为零，这将启动注销过程
   * @return PJ_SUCCESS 为成功，或相应的错误代码
   */

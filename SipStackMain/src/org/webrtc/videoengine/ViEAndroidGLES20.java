...
public class ViEAndroidGLES20 extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    public ViEAndroidGLES20(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(false, 0, 0);
    }
    ...
    private void init(boolean translucent, int depth, int stencil) {
        ...
        if (translucent) {
            this.getHolder().setFormat(PixelFormat.TRANSLUCENT); // 透明
        }
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        if (!openGLCreated) {
            LogUtils.e("ViEAndroidGLES20", "nativeObject: " + nativeObject + " viewWidth: " + viewWidth + " viewHeight: " + viewHeight);
